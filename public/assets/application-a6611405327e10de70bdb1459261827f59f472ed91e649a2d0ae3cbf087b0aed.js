...
Function.prototype.bind=function(o){var fn=this,a=[].slice.call(arguments,1);return function(){var b=[].slice.call(arguments);return fn.apply(o,a.concat(b));};};
//     Underscore.js 1.8.2
...
(function() { this.JST || (this.JST = {}); this.JST["groups/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');}return __p.join('');};
}).call(this);
